...
module.exports = {
	...
	admin: {
		...
		validEmails: ["skchkadiyala@axway.com"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [706882619804222]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: 'hn3Iz8YqNuPdK+Not073qlDruIuy+YrFkW0fTYQs9rs=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'e3uWqzh4zBqJS/GaHyfhPt07oYuxIfxkZNpBnBJwpIU4S6TkDEo+0xITmTNaWhHrMSxGjsKlZTlS+koiIPUbeg==',
		secret: 'MMRYzzCYp5dpvjIc1+RbZmPIH6lu4e8U', // should be a large unguessable string
	...
	cookieSecret: '0fpwwwGlPNuePkhU7DluzcZnLjmtAg/l',
